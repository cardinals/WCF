...
namespace SWSoft.Framework
{
    ...
    public class DBVisitor1<TModel> where TModel : Entry, new()
    {
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        protected static ConnectionStringSettings ConnectionString = ConfigurationManager.ConnectionStrings["ConnectionString1"];
        /// <summary>
