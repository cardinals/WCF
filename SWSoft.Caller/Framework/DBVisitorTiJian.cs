...
namespace SWSoft.Caller.Framework
{
    public class DBVisitorTiJian
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static ConnectionStringSettings ConnectionString = ConfigurationManager.ConnectionStrings["ConnectionStringTiJian"];
        /// <summary>
