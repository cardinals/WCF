...
namespace HIS4.Schemas
{
    public class SHEBEIYY_IN : MessageIn
    {
        ...
        /// 诊断信息
        /// </summary>
        public List<ZHENDUANXX> ZHENDUANXXMX { get; set; }


        public SHEBEIYY_IN()
        {
            this.JIANCHALB = new List<JIANCHAXX>();

            this.ZHENDUANXXMX = new List<ZHENDUANXX>();
        }
    }
