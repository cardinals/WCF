    ...
    public class Submit
    {
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            foreach (KeyValuePair<string, string> temp in dicPara)
            {
                ...
                sbHtml.Append(temp.Key + "=" + System.Web.HttpUtility.UrlEncode(temp.Value, System.Text.Encoding.GetEncoding("utf-8")) + "&");
            }
