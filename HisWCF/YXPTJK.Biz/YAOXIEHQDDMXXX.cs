...
{
    public class YAOXIEHQDDMXXX : IMessage<YAOXIEHQDDMXXX_IN, YAOXIEHQDDMXXX_OUT>
    {
        /// <summary>
        /// json字符串转换为Xml对象
        /// </summary>
        ...
        {
            OutObject = new YAOXIEHQDDMXXX_OUT();
            ...
            ypptdz = ypptdz + "/hospitalInterface/drug/purchaseOrder/orderDetail/getOrderDetail";
            ...
            //1、获取令牌
            System.Collections.Specialized.NameValueCollection postHosGetOrderDetail = new System.Collections.Specialized.NameValueCollection();
            postHosGetOrderDetail.Add("accessToken", InObject.JIEKOUDYPJ);
            postHosGetOrderDetail.Add("currentPageNumber", InObject.DANGQIANYM);
            postHosGetOrderDetail.Add("orderDetailInfo", inJason);



            try
            {
                byte[] byRemoteInfo = webClientObj.UploadValues(ypptdz, "POST", postHosGetOrderDetail);
                string strGetOrderDetail = System.Text.Encoding.UTF8.GetString(byRemoteInfo);

                strGetOrderDetail = strGetOrderDetail.Replace(":null", ":0");
                strGetOrderDetail = strGetOrderDetail.Replace("&lt;", "");
                strGetOrderDetail = strGetOrderDetail.Replace("&gt;", "");
                strGetOrderDetail = strGetOrderDetail.Replace("&;", "");


                var xmldom = new XmlDocument();
                var Xml = Json2Xml(strGetOrderDetail);
                ...
                if (returncode == "1")
                {
                    ...
                    OutObject.CAIGOUDDFHMX = "<![CDATA[" + xmldom.GetElementsByTagName("DATALIST").Item(0).InnerXml + "]]>";
