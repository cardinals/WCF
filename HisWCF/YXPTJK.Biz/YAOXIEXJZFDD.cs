...
{
    class YAOXIEXJZFDD : IMessage<YAOXIEXJZFDD_IN, YAOXIEXJZFDD_OUT>
    {
        ...
        {
            OutObject = new YAOXIEXJZFDD_OUT();


            var ypptdz = System.Configuration.ConfigurationManager.AppSettings["YXPTDZ"];
            ypptdz = ypptdz + "/hospitalInterface/drug/payOrder/addOrder";
            ...
            string ddxx = "{" +
                            "\"hospitalOrderId\":\"" + InObject.YIYUANDDZJ + "\"," + 
                            "\"companyId\":\"" + InObject.QIYEBH + "\"," +
                            "\"orderRemark\":\"" + InObject.YIYUANDDBZ +"\""+ 
                           "}";
