...
{
    public class YAOXIETJZFDD : IMessage<YAOXIETJZFDD_IN, YAOXIETJZFDD_OUT>
    {
        /// <summary>
        /// json字符串转换为Xml对象
        /// </summary>
        ...
        {
            OutObject = new YAOXIETJZFDD_OUT();



            var ypptdz = System.Configuration.ConfigurationManager.AppSettings["YXPTDZ"];
            ypptdz = ypptdz + "/hospitalInterface/drug/payOrder/submitOrder";
            ...
            try
            {
                ...
                strSubmitOrder = strSubmitOrder.Replace(":null", ":0");
                strSubmitOrder = strSubmitOrder.Replace("&lt;", "");
                strSubmitOrder = strSubmitOrder.Replace("&gt;", "");
                strSubmitOrder = strSubmitOrder.Replace("&;", "");
