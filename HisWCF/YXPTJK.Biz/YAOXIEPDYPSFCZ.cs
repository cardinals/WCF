...
{
    public class YAOXIEPDYPSFCZ : IMessage<YAOXIEPDYPSFCZ_IN, YAOXIEPDYPSFCZ_OUT>
    {
        /// <summary>
        /// json字符串转换为Xml对象
        /// </summary>
        ...
        {
            OutObject = new YAOXIEPDYPSFCZ_OUT();


            var ypptdz = System.Configuration.ConfigurationManager.AppSettings["YXPTDZ"];
            ypptdz = ypptdz + "/hospitalInterface/drug/procurecatalog/checkExist";
            ...
            postHosCheckExist.Add("procureCatalogInfo", inJason);
            ...
            try
            {
                ...
                if (returncode == "1")
                {
                    ...
                    OutObject.SHANGPINFHMX = "<![CDATA[" + xmldom.GetElementsByTagName("RESULTLIST").Item(0).InnerXml + "]]>"; 
